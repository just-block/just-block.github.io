...
**Is it open source?**
<br>The landing page and admin panel frontend are open source. The extension and backend code are kept private since JustBlock has paid users. The repo is published using [git-filter](https://github.com/kubk/git-filter/) to share only the public parts.